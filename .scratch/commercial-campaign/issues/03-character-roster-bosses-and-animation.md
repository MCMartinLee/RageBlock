...
- [ ] Three bosses have visible health, two or more readable attacks, and arena-rule changes.
...
Archetype definitions now provide health, approach behavior, telegraphs, and counters, and the scene tracks the shared player animation-state vocabulary. Dedicated boss arena rules and full animation presentation remain open.
